...
target = r'E:\Documents2\ANU\Projects\RSD_Impact\ForceDirectedTree_1.html'
...
<div>
    ...
    <p>A total score for all items can be added by configuring the chart to have a single common root.  This may be useful if there is a need
    to identify a score for overall effort or value.
