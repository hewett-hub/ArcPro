...
class Covid19CumulativeTestsByDateAndPostcode(object):
    ...
    @staticmethod
    def list_chunks(master_list, chunk_size):
...
class UpdateTask(object):
    ...
    """
    def __init__(self):
        self.feature_service = Covid19CumulativeTestsByDateAndPostcode()
    ...
    def update(self):
        ...
        tests_field = self.source_data.tests_field
        data = {}
        for row in source_values:
            ...
            if data_item:
                data_item['tests'][date_code] = row.attributes[tests_field]
            else:
                data_item = {'tests': {date_code: row.attributes[tests_field]}, 'xy': row.geometry}
        ...
        for postcode, postcode_values in data.items():
            notifications = postcode_values['tests']
            ...
            while start_date < end_date:
                ...
                if total > 0:
                    ...
                    update_data[id_value] = {'tests': total, 'xy': xy}
...
if __name__ == "__main__":
    ...
    parser.add_argument("-l", "--log",
                        required=False,
                        default=r'E:\Documents2\tmp\Covid19CumulativeTestsByDateAndPostcode.log',
